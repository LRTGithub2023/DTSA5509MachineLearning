...
def diagnosticPlots(targetStock, lowestErrorSPModel, testClosePredV, closeTestActual, closeTestPred, filename):
        # Data for all plots:
        #===================
...
def singlePredModelling(targetStock, securitiesD):
        ...
        diagnosticPlots(targetStock, lowestErrorSPModel, testClosePredV=testPredSPV, closeTestActual=testActualClose, closeTestPred=lowestErrorSPPred, filename="diagnosticsSinglePred")
...
def singleMultiPredWrapper():
        ...
        diagnosticPlots(targetStock, bestMultiPredglmModel, bestMultiClosePredV, closeTestActual, lowestClosePred, 
